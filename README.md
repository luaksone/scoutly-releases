...
[![Windows](https://img.shields.io/badge/Windows-1.12.11-0078D4?logo=windows11&logoColor=white)](https://github.com/luaksone/scoutly-releases/releases/latest)
...
| --- | --- | --- |
| Windows | [Installer](Scoutly-Setup-1.12.11-x64.exe) | 1.12.11 |
| Windows | [Portable application](Scoutly-Portable-1.12.11-x64.exe) | 1.12.11 |
...
```powershell
Get-FileHash .\Scoutly-Setup-1.12.11-x64.exe -Algorithm SHA256
```
