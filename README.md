...
[![Windows](https://img.shields.io/badge/Windows-1.12.3-0078D4?logo=windows11&logoColor=white)](https://github.com/luaksone/scoutly-releases/releases/latest)
[![Android](https://img.shields.io/badge/Android-1.4.4-3DDC84?logo=android&logoColor=white)](https://github.com/luaksone/scoutly-releases/releases/latest)
...
| --- | --- | --- |
| Windows | [Installer](Scoutly-Setup-1.12.3-x64.exe) | 1.12.3 |
| Windows | [Portable application](Scoutly-Portable-1.12.3-x64.exe) | 1.12.3 |
| Android | [APK](Scoutly-Mobile-1.4.4-debug.apk) | 1.4.4 |
...
```powershell
Get-FileHash .\Scoutly-Setup-1.12.3-x64.exe -Algorithm SHA256
```
